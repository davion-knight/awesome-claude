...
documentationUrl: "https://stytch.com/docs/resources/workspace-management/stytch-mcp-server"
downloadUrl: /downloads/mcp/stytch-mcp-server.mcpb
packageVerified: true
installable: true
installCommand: >-
  claude mcp add --transport http stytch https://mcp.stytch.dev/mcp && claude mcp
  list
usageSnippet: >-
  claude mcp add --transport http stytch https://mcp.stytch.dev/mcp && claude mcp
  list
...
prerequisites:
  ...
  - "Network access to mcp.stytch.dev (HTTPS transport)"
  - >-
...
keywords:
  - stytch mcp server
  - claude stytch auth integration
...
1. Run: claude mcp add --transport http stytch https://mcp.stytch.dev/mcp
