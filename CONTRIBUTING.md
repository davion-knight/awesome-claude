...
> **Submit your own work, with credit to original sources.** Plagiarism — copying another contributor's PR or submission and passing it off as your own, including duplicated or lightly reworded copies filed under a different account — is a hard violation. Anyone attempting to cheat, copy from others, or farm contribution rewards is **permanently blocked from contributing across all of our repositories**. Enforcement is proportional — reward-farming (manufacturing low-value issues to harvest credit, or bulk low-value submissions filed for points) earns a warning and no linked-issue bonus, and repeat or coordinated farming is closed on sight and blocked. See [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md) for the full ladder.
